                ...
                <ul>
                    <li class="sidebar-dropdown" >
                        <span class="list-item">
                            <span>Requests</span>
                            <span class="badge badge-pill">{{count.products + count.calls + count.services}}</span>
                        </span>
                        <div class="sidebar-submenu">
                            <ul>
                                <li>
                                    <router-link :to="{name:'productRequests'}" @click="forceUpdate">
                                        <span><img v-lazy="'/assets/icons/shopping-basket.png'" alt=""/></span>
                                        Product requests<span class="badge badge-pill" v-if="count.products">{{count.products}}</span>
                                    </router-link>
                                </li>
                                <li>
                                    <router-link :to="{name:'serviceRequests'}">
                                        <span><img v-lazy="'/assets/icons/settings.png'" alt=""/></span>
                                        Service requests<span class="badge badge-pill" v-if="count.services">{{count.services}}</span>
                                    </router-link>
                                </li>
                                <li>
                                    <router-link :to="{name:'callRequests'}" @click="forceUpdate">
                                        <span><img v-lazy="'/assets/icons/chat.png'" alt=""/></span>
                                        Call requests<span class="badge badge-pill" v-if="count.calls">{{count.calls}}</span>
                                    </router-link>
                                </li>
                            </ul>
                        </div>
                    ...
                    <li>
                        <router-link class="list-item" :to="{name:'Products'}">Products</router-link>
                    </li>
                    <li>
                        <router-link class="list-item" :to="{name:'Projects'}">Projects</router-link>
                    </li>
                    <li>
                        <router-link class="list-item" :to="{name:'News'}">News</router-link>
                    </li>
                    <li>
                        <router-link class="list-item" :to="{name:'Careers'}">Careers</router-link>
                    </li>
                </ul>
            </div>
            <!-- sidebar-menu  -->
